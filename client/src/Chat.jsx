        ...
        <div className="flex h-screen">
            <div className="bg-white w-1/3 flex flex-col">
                ...
                <div className="p-2 text-center flex items-center justify-center">
                    <span className="flex mr-2 text-sm text-gray-600 items-center gap-1 bg-gray-50 py-1 px-2 rounded-sm border" >
                ...
                {!!selectedUserId && (
                    <form className="flex gap-2" onSubmit={sendMessage}>
                        <input type="text"
                                ...
                                placeholder="Type your message here" className="bg-white flex-grow border p-2 rounded-sm" />
